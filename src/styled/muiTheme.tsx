...
import SignRightIcon from '/icons/arrows/sign-right.svg';
import CheckboxCheckedIcon from '/icons/checkbox-checked.svg';
import RadioActiveIcon from '/icons/radio-active.svg';
import RadioIcon from '/icons/radio.svg';
import RatingEmpty from '/icons/rating/empty.svg';
import RatingFilled from '/icons/rating/filled.svg';
...
export const muiTheme = createTheme({
	components: {
		...
		MuiStepper: {
			defaultProps: {
				connector: <MuiStepConnector classes={{ root: 'step-connector-root', line: 'step-connector-line' }} />,
			},
		},
		MuiStep: {
			defaultProps: {
